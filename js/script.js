...
const MAXIMOS_INTENTOS = 10, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./images/play/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        // La ruta de las imágenes. Puede ser relativa o absoluta
        imagenes: [
            "./images/play/mario.jpg",
            "./images/play/luigi.jpg",
            "./images/play/browser.jpg",
            "./images/play/dk.jpg",
            "./images/play/koopa.jpg",
            "./images/play/toad.jpg",
        ],
        memorama: [],
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `Creado por <a href="#">Ing Gustavo Chaparro</a>
                <br></br>
                <strong><img src="images/icon/OGTecno.png" with="80" height="80"> OGDesign</strong>
                <br>
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="./images/play/perdiste.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="./images/play/ganaste.png" alt="Ganaste">
